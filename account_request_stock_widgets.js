(async () => {
    ...
    async function loadStockRequests() {
        ...
        let data = await FirebaseModule.fetchJSON('https://storehaccounts-website-default-rtdb.firebaseio.com/lowkeep.json?orderBy="$key"&limitToFirst=20&print=pretty');
