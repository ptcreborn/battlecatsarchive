...
<div class="bca-reply-widget-container alert-message warning"><div
    ...
    async function triggerCommentEditor() {
        ...
        comment_parent_container.addEventListener('click', (e) => {
            if (e.target.matches('#trigger_comment_editor')) {
                if (!isTriggered) {
                    appendJSFile('https://rawcdn.githack.com/ptcreborn/battlecatsarchive/2b6225343668868dce320bf2d6134f9eee165318/bca-official-comment-editor.js');
                    isTriggered = true;
                    return;
                }
    ...
    function triggerCommentViewer() {
        setTimeout(() => {
            appendCSSFile('https://rawcdn.githack.com/ptcreborn/battlecatsarchive/7e37318b6d8c9fb3f6f5683ef1edf39e6217ed0f/bca-comment-viewer.css');
            appendJSFile('https://rawcdn.githack.com/ptcreborn/battlecatsarchive/ef9774405bb44090e8fafaeed4cd5c3691b2d0eb/bca-official-comment-viewer.js');
        }, 1);
    }
})();
