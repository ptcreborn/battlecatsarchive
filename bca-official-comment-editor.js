...
<button onclick="execCmd('createLink')" title="Link">🔗Link</button><button onclick="document.querySelector('.bca-file-input').click()">🖼️Image</button><button onclick="addYoutubeVideo()">🎥Youtube</button></div>
...
">
    ...
    async function initializeComment() {
        ...
        appendCSSFile('https://rawcdn.githack.com/ptcreborn/battlecatsarchive/2b7bcb6699f30a3cf3b7f4a752e5be02cb49f7f8/bca-comment-editor.css');
